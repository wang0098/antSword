          ...
          list: [
            {
              ...
              checked: display_shellmanager_hiddencolumns.indexOf(0) != -1,
              ...
              type: "checkbox",
              label: LANG_HC['ip'],
              name: 'hidden_columns[1]',
              checked: display_shellmanager_hiddencolumns.indexOf(1) != -1,
              position: "label-right",
              value: 2
            }, {
              type: 'newcolumn',
              ...
              type: "checkbox",
              label: LANG_HC['addr'],
              name: 'hidden_columns[2]',
              checked: display_shellmanager_hiddencolumns.indexOf(2) != -1,
              position: "label-right",
              value: 3
            }, {
              type: 'newcolumn',
              ...
              type: "checkbox",
              label: LANG_HC['note'],
              name: 'hidden_columns[3]',
              checked: display_shellmanager_hiddencolumns.indexOf(3) != -1,
              position: "label-right",
              value: 4
            }, {
              type: 'newcolumn',
              ...
              type: "checkbox",
              label: LANG_HC['ctime'],
              name: 'hidden_columns[4]',
              checked: display_shellmanager_hiddencolumns.indexOf(4) != -1,
              position: "label-right",
              value: 5
            }, {
              type: 'newcolumn',
